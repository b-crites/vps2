...
const RefModal = (props) =>{
    ...
    return(
        <>
      <div
      className= {`fixed inset-0 flex items-center justify-center bg-gray-400 bg-opacity-70 ${props.refOpen ? "visible" : "hidden"}`}>
        <div className="bg-teal pt-5 rounded-xl min-w-fit">
