...
export default function ReferralForm(props) {
  ...
  const formHeightClass = "gap-6";
  const formWidthClass = "min-w-[800px] w-[800px] mb-16";
  ...
  return (
    <form
      ...
      className={`${formWidthClass} bg-white mx-auto grid grid-cols-2 ${formHeightClass} p-5`}
    >
      ...
      <div className="form__group field">
        <input
          ...
          required
        />
        <label htmlFor="provNum" className="form__label">
